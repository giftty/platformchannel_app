...
// this is what displays the text login and the icon at the bottom of the login page
...
// This code dispalys the user inputs on the user page
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    SizedBox(height: 45),
                   //calls to the user widget functions
